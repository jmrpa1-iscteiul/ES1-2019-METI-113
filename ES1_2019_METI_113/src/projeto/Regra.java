...
public class Regra {
	...
	String name_metrica1, operator, name_metrica2; 
	int value_metrica1, value_metrica2;
	
	public Regra(String name_metrica1, int value_metrica1, String operator, String name_metrica2, int value_metrica2) {
